...
@endif  
                ...
                <div class="card-header" style="background-color:green;color:white">{{ __('Add Your Personal and Bank Detailes') }}</div> 
                   <div class="card-body">
                       ...
                       <div class="container">
                         <form method="post" action="/added_farmer" enctype="multipart/form-data">
                          @csrf
                         <div class="row">
                             <div class="col-sm-4">Farmer Name
                                <input type="text" class="form-control" id="farmarname" placeholder="Former Full Name" name="farmarname"  required=""><br>
                              </div>
                             <div class="col-sm-4">Gender
                              ...
                              <div class="col-sm-4">Address
                                <input type="text" class="form-control" placeholder="Enter Address" name="address" required=""></input><br>
                              </div> 
                           <br>
       ...
       <div class="col-sm-4">Alternate Number:
        ...
        <input type="file" class="form-control" id="email" placeholder="LicenseNo" name="landcopy"   required="">
                         ...
                         <div class="col-sm-4">Land Owned:(Ex:1 akar,2 akar,...)
                                <input type="number" class="form-control" id="email" placeholder="Enter Akar" name="landakar"  maxlength="100" required=""><br>
                         </div>
