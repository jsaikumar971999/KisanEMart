...
@endif  
                ...
                <div class="card-header" style="background-color:green;color:white">{{ __('Add Your Personal and Bank Detailes') }}</div> 
                   <div class="card-body">
                       ...
                       <div class="container">
                         <form method="post" action="/added_trader" enctype="multipart/form-data">
                          @csrf
                       <div class="row">
                           ...
                           <option value="Company">Company</option>
                             ...
                             <div class="col-sm-4">Proprietor Name
                              <input type="text" class="form-control" placeholder="Name of proprietor"
                               name="proprietorname" required=""></input><br>
                              </div>
      ...
      <select name="mandal" id="child_selection" class="form-control" required>
                <option>--Select Mandal--</option>
                        ...
                        <div class="col-sm-4">Pincode
                           <input type="number" class="form-control" id="email" placeholder="Enter Pincode" name="pincode"  maxlength="6" required=""><br>
                          </div>
                             
                          <div class="col-sm-4">Date of birth
                                <input type="date" class="form-control" id="email" placeholder="Enter phone No" name="dateofbirth"   required=""><br>
                           </div>
                           <div class="col-sm-4">Email-Id
                                <input type="email" class="form-control" id="email" placeholder="Enter Email-Id" name="email"   required=""><br>
                             </div>

                             <div class="col-sm-4">Address
                                <input type="text" class="form-control" id="email" placeholder="House no,street /lane, village, post office,etc:" name="address"   required=""><br>
                             </div>
                          ...
                          <div class="col-sm-4">ID Type
                           ...
                           <div class="col-sm-4" style="color: red">*Enter ID (TraderID)
                                <input type="text" class="form-control" id="email" placeholder="Adhar Or PanCard" name="idname"  maxlength="12" required=""><br>
                           </div>
                            <div class="col-sm-4">Mobile Number: 
                                <input type="number" class="form-control" id="email" placeholder="Enter phone No" name="phone"  maxlength="10" required=""><br>
                              </div>
        
       <div class="col-sm-4">Alternate Number:
             <input type="number" class="form-control" id="email" placeholder="Alternate Mobile Number" name="phone2"  maxlength="10" required=""><br>
       </div>
 

         <div class="row">      
        <div class="col-sm-4">Mill name:
      <input type="text" class="form-control" id="email" placeholder="Mill Name" name="millname"   required="">
        </div>
        
  
                         <div class="col-sm-4">Year of establishment
                                <input type="date" class="form-control" id="email" placeholder="Year of establishment:" name="yearofmill"  maxlength="100" required=""><br>
                         </div>
                         <div class="col-sm-4">Mill Type
                                <select name="milltype" id="parent_selection" class="form-control" required> 
                                   ...
                                   <option value="raw">raw</option>
                                    <option value="paraboiled">paraboiled </option>
                         ...
                         <div class="col-sm-4">Capacity of mill:
                                <input type="number" class="form-control" id="email" placeholder="Capacity of Mill Eg:1000" name="millcapacity"  maxlength="100" required=""><br>
                         </div>
                         <div class="col-sm-4">Mill pan card no:
                                <input type="text" class="form-control" id="email" placeholder="Mill pan card no:" name="millpancard"  maxlength="100" required=""><br>
                         </div>
                         
                         <div class="col-sm-4">GST number
                                <input type="text" class="form-control" id="email" placeholder="GST number" name="gstnumber"  maxlength="100" required=""><br>
                         </div>
                          <div class="col-sm-4">State pollution control board licence no:
      
                                <input type="text" class="form-control" id="email" placeholder="Capacity of Mill" name="spcblicence"  maxlength="100" required=""><br>
                         </div>
                         <div class="col-sm-4">SPCB licence valid upto
                                <input type="date" class="form-control" id="email" placeholder="Mill pan card no:" name="spcbvalid"  maxlength="100" required=""><br>
                         </div>
                         
                         <div class="col-sm-4">Mill license number:
                                <input type="text" class="form-control" id="email" placeholder="Mill license number:" name="milllicense"  maxlength="100" required=""><br>
                         </div>
                         <div class="col-sm-4">Valid upto 
                                <input type="date" class="form-control" id="email" placeholder="Valid upto" name="validupto"  maxlength="100" required=""><br>
                         </div>
                          <div class="col-sm-4">Mill Location
                                <input type="text" class="form-control" id="email" placeholder="District Tashil Plat No:" name="milllocation"  maxlength="100" required=""><br>
                         </div>
                    ...
                    <option value="OTHER BANK">OTHER BANK</option>
                      ...
                      <div class="col-sm-4">Account Holder Name
                       <input type="text" class="form-control" id="accountno" placeholder="Account holder Name" name="acholdername"  maxlength="18" required=""><br>
                      </div>
                         
                         <div class="col-sm-4">Account Number
                                <input type="number" class="form-control" id="accountno" placeholder="Account No" name="accountno"  maxlength="18" required=""><br>
                         </div>

                          <div class="col-sm-4">IFSC Code
                                <input type="text" class="form-control" id="email" placeholder="Ifsc Code" name="ifsccode"  maxlength="11" required=""><br>
                         </div>
                          ...
                          <div class="col-sm-4" >Registration Acknowledgement:<br>
                            <input type="checkbox" id="sms" name="getsms" value="SMS" >
                               <label for="sms">Get SMS</label><br>
                                <input type="checkbox" id="mail" name="getmail" value="EMAIL">
