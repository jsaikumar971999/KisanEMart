...
@endif  
                ...
                <div class="card-header" style="background-color:green;color:white;font-size:15px;">{{ __('My Registrations') }}</div> 
                  <div class="card-body">
                   ...
                   <form method="post" action="/traderslotdisplay">
                        @csrf
        
                      <div class="form-group row">
                            <label for="" class="col-md-8 col-form-label text-md-left">{{ __('Treader ID') }}</label>

                            <div class="col-md-8">
                              <input type="text" name="traderid" placeholder="Enetr Trader ID" required="" class="form-control">
                            </div>
