...
@endif  
                ...
                <div class="card-header" style="background-color:purple;color:white">{{ __('Add Crop And Price Details') }}</div> 
                   <div class="card-body"> 
                                  
                       <div class="container">
                         <form method="post" action="/admin_add_crop" enctype="multipart/form-data">
                          @csrf
                         <div class="row">
...
<div class="col-sm-4">Mandal
      <select name="mandal" id="child_selection" class="form-control" required>
                <option>--Select Mandal--</option>
                        ...
                        <div class="col-sm-4">Crop Name
                           <input type="text" class="form-control" id="email" placeholder="Rice,wheat" name="crop"   required=""><br>
                          </div>
                             
                          <div class="col-sm-4">Crop Price
                                <input type="text" class="form-control" id="email" placeholder="Enter price" name="crop_price"   required=""><br>
                           </div>
